...
The Aeon DataJoint pipeline, implemented in the `aeon_mecha` [repository](target-repositories), consists of a set of [tables](datajoint-docs:core/datajoint-python/0.14/concepts/principles/) designed to manage, contain, and process data generated by the [Aeon acquisition system](target-aeon-acquisition-reference). 
