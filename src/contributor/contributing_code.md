...
In brief, each repository uses 'main' as the long-lived branch. 
Feature and bug fix branches are branched off of 'main', with Pull Requests sent back into 'main'. 
Maintainers squash merge approved Pull Requests into 'main' so the commit history stays concise. 
